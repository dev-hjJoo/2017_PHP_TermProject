		...
		<td>
			<table height=525 width=60% align=center class=board>
				<tr height=10% width=100%>
					<td width=25%>
						<font size=5> -- <font color=red>m</font>odify <font color=green>m</font>ode </font>
					</td>
					<td width=25%>
					</td>
...
for($i=$upline_start; $i<$upline_start+4; $i++) {
	...
	echo("
					...
					<font size=3 face='맑은 고딕'> <a href='http://localhost/modify_gift.php?i=$i&arrange=$arrange'> <font color=green> $name </font> </a> </font>
					</td>
	");
...
for($i=$downline_start; $i<$downline_start+4; $i++) {
	...
	echo("				<font size=3 face='맑은 고딕'> <a href='http://localhost/modify_gift.php?i=$i&arrange=$arrange'> <font color=green> $name </font> </a> </font>");
...
for($i=1; $i <=$count; $i++) {
	if($i % 8 == 1) {
		$index += 1;
		echo("
						<a href='http://localhost/m_gift_to_children.php?cpage=$index&arrange=$arrange'>
						$index
						</a> &nbsp;
		");
	}
